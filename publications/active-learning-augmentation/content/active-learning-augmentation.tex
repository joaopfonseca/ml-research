...
the feature space and is reconstructed into the input space.

In this paper, we will focus on heuristic data
augmentation. 

While some techniques may depend on the domain,
others may be considered domain-agnostic. Domain-agnostic techniques are
discussed in Subsection~\ref{sec:heuristic}.
