...
Table~\ref{tab:optimal_mean_std_scores}. Using a curated The proposed AL
method produces classifiers that are almost always able to outperform
classifiers using the full training set (\textit{i.e.,} the ones labeled as
MP).
...
important to account for the multiple comparison problem.
