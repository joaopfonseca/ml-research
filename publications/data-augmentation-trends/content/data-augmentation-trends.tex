...
\author*[1]{\fnm{Joao} \sur{Fonseca}}\email{joaopfonseca@novaims.unl.pt}

\author[1]{\fnm{Fernando} \sur{Bacao}}\email{bacao@novaims.unl.pt}

\affil*[1]{\orgdiv{NOVA Information Management School}, \orgname{Universidade
Nova de Lisboa}, \orgaddress{\street{Campus de Campolide}, 
\postcode{1070--312} \state{Lisboa}, \country{Portugal}}}
...
\keywords{Data Augmentation, Generative Adversarial Networks, Regularization
Methods, Overfitting}
