...
\abstract{
    ...
    of newly created artificial data by avoiding the generation of noisy data
    while effectively overcome data imbalance. The performance of K-means
    SMOTE is compared to other popular oversampling methods using seven remote
    sensing benchmark datasets and a variety of classifiers and evaluation
    metrics. The results show that the proposed method consistently
    outperforms the remaining oversamplers and produces higher quality land
