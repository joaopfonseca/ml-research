...
in the context of machine learning, there is no such \added{an} application
...
those tests use overall accuracy. This represents an improvement over the
benchmark oversamplers, showing that generally K-SMOTE is the best choice even
when overall accuracy is used as the main performance metric.
