...
\pgfplotstabletypeset[
	...
	every last row/.style={after row=\bottomrule
        \caption{\label{tab:wide_optimal_aulc}
            Mean cross-validation AULC scores of AL algorithms for each
            dataset.  Legend: IP Indian Pines, KSC Kennedy Space Center, PC 
            Pavia Center, PU Pavia University, SA Salinas A.}}
...
\pgfplotstabletypeset[
	...
	every last row/.style={after row=\bottomrule
        \caption{\label{tab:friedman_test}
            ...
            level of $\alpha = 0.1$. The null hypothesis is that there is no 
...
\pgfplotstabletypeset[
	...
	every last row/.style={after row=\bottomrule
        \caption{\label{tab:wilcoxon_test}
                ...
                are statistically significant at a level of $\alpha = 0.1$. The 
