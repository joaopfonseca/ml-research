"""
Adapted from PyTorch Lightning Bolts
References:
...
class LARS(optimizer.Optimizer):
    ...
    Args:
        ...
        trust_coefficient (float, optional): trust coefficient for computing LR
            (default: 0.001)
        eps (float, optional): eps for division denominator (default: 1e-8)
        exclude_bias_from_adaption (bool, optional): exclude bias and normalization
            layers from lars. Defaults to False.
    ...
    def __init__(
        ...
        defaults = dict(
            ...
            eps=eps,
            exclude_bias_from_adaption=exclude_bias_from_adaption,
        )
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            exclude_bias_from_adaption = group["exclude_bias_from_adaption"]

            for p in group["params"]:
                if p.grad is None or (p.ndim == 1 and exclude_bias_from_adaption):
                    continue
